...
public class FragmentA extends Fragment
{
    ...
    private void setupViewPager(ViewPager viewPager)
    {
        ...
        adapter.addFragment(new FragmentA1(), "Brighton");
        adapter.addFragment(new FragmentA2(), "London");
        adapter.addFragment(new FragmentA3(), "Rome");
        adapter.addFragment(new FragmentA4(), "Oxford");
        adapter.addFragment(new FragmentA5(), "Birmingham");
